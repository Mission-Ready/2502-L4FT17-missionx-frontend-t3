          ...
          <div className={styles.innerContainer}>
            ...
            <ul className={styles.listOfStudents}>
              <li className={styles.box}>
                <button className={styles.studentsBtn}></button>
                <img
                  className={styles.img}
                  src="public\images\students\AidenAndrews.png"
                  alt=""
                />{" "}
                AIDEN needs help with his project.
              </li>
              <li className={styles.box}>
                <button className={styles.studentsBtn}></button>
                <img
                  ...
                  alt=""
                />{" "}
                RAWIRI needs help with his project.
              </li>
              <li className={styles.box}>
                <button className={styles.studentsBtn}></button>
                <img
                  className={styles.img}
                  src="public\images\students\NeveahMachenry.png"
                  alt=""
                />{" "}
                NEVEAH needs help with her project.
              </li>
              <li className={styles.box}>
                <button className={styles.studentsBtn}></button>
                <img
                  className={styles.img}
                  src="public\images\students\TokioHan.png"
                  alt=""
                />{" "}
                TOKIO needs help with her project.
              </li>
            </ul>
          </div>
        </section>
