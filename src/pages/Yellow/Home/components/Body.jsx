...
export default function Body() {
 ...
 {/* how our programmes helps teachers and schools section */}
      ...
      {/* pop up for key competencies */}
            <div className={style.informationOnClick} style = {{fontFamily:"Sans, Regular ",fontSize:"16px",color:"#606060", backgroundColor:"#EFEFF1"}}>
...
{/* ENQUIRE NOW SECTION */}
        <div className={style.enquireNow}>
           ...
           <section className={style.enquireNowRight}>
            <h1 style = {{fontFamily: "Nunito, Bold", fontSize:"40px",color:"#6C6C6C", width:"30em"}}>
            What are you waiting for?
            </h1>
            <br />
            <br />
            <h3 style = {{fontFamily: "Nunito, Bold", fontSize:"30px",color:"#6C6C6C", width:"30em"}}>
            Start teaching Digital Technologies today. 
            </h3>
          

            <h4 style = {{fontFamily: "Nunito, Bold", fontSize:"20px",color:"#6C6C6C", width:"30em"}}>
